...
public class EventService {
	...
	public boolean haveInvitations(Long eventId) {
		return inviteService.eventHaveInvitations(eventId);
	}
	...
	public String validateCapacity(Event event) {
		...
		if(capacity < registrationService.quantityOfRegistrationByEvent(event.getId())) {
			//Editado por lepo.
			message = "<b>Error:</b> no se puede modificar la capacidad del evento a un número menor de la cantidad de inscripciones.";
		}
		return message;
	}
