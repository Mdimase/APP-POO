...
public class InviteController {
	...
	public String deleteInvite(@PathVariable Long eventId, Model model, RedirectAttributes redirectAttributes) {
		String message = null;
	...
	public String addInvite (String username, @PathVariable Long eventId, Model model, RedirectAttributes redirectAttributes) {
		...
		//si no se elige un nombre de usuario se refresca la pagina
